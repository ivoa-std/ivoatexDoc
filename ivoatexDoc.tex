...
While \ivoatex~is not usually explicitly
...
sect.~\ref{sect:authoring}.  Added in this document's version 1.2,
...
To control the number of different tools editors might, it
...
IVOA repositories are tranistioning from using ``master'' as the main
...
On the left side of the settings page, chose ``Branches'' and either edit the \verb|main|

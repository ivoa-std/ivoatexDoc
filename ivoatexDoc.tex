...
will automatically add links to the pervious version and a changelog
section.  While you will probably want to edit the date later on, this
...
\begin{itemize}
\item Added a regression test.
\item Added a \verb|new-release| target to help with, well, advancing
versions.
\end{itemize}
